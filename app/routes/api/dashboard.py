...
def get_user_flans():
    ...
    query = Flan.query.filter_by(id_user=current_user.id_user) \
...
def get_user_evaluations():
    ...
    query = Evaluation.query.filter_by(id_user=current_user.id_user) \
...
def get_recent_evaluations():
    ...
    return jsonify({
        'data': [eval.to_dict(include_flan=True, include_utilisateur=True) for eval in evaluations],
        'total': total,
        'limit': limit,
        'offset': offset
    })