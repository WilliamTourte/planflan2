...
def add_security_headers(response):
    ...
    # Configuration adaptée pour une application Flask avec Google Maps, Leaflet et ressources locales
    csp = (
        "default-src 'self' http://localhost; "
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://maps.googleapis.com https://www.googletagmanager.com cdn.jsdelivr.net unpkg.com http://localhost; "
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com cdn.jsdelivr.net unpkg.com http://localhost; "
        "img-src 'self' data: https://maps.googleapis.com https://maps.gstatic.com cdn.jsdelivr.net unpkg.com a.tile.openstreetmap.org b.tile.openstreetmap.org c.tile.openstreetmap.org; "
        "font-src 'self' https://fonts.gstatic.com cdn.jsdelivr.net unpkg.com; "
        "connect-src 'self' https://maps.googleapis.com cdn.jsdelivr.net unpkg.com http://localhost; "
    ...
    if request.endpoint and any(secure_endpoint in request.endpoint 
